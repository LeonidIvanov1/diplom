...
import {Button, ButtonGroup, Col, Form, FormControl, InputGroup, Row, Table} from "react-bootstrap";
            ...
            for (let i = 0; i < books.length; i++) {
                let row = <tr key={i + books[i].id} id={books[i].id}>
                    ...
                    <td><ButtonGroup aria-label="Basic example">
                        <Button variant="secondary" value={books[i].id} onClick={this.extendLiterature}>Продлить</Button>
                        <Button className="delete-user" variant="secondary" value={books[i].id} onClick={this.returnLiterature}>Вернуть</Button>
                    </ButtonGroup>
                    </td>
                ...
                <Form>
                    <Form.Row>
                        <Form.Group as={Col} controlId="fioInput">
                            ...
                            <Form.Control required readonly type="text" placeholder="Введите ФИО"
                        ...
                        <Form.Group as={Col} controlId="roleInput">
                            ...
                            <Form.Control type="text" readonly
                                          value={this.getRole(this.state.role)}
                            />
                        </Form.Group>
